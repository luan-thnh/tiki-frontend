        ...
        <div className="dialog__container">
          <div className="dialog__content">
            ...
            <div className="dialog__content-text">
              <h5 className="dialog__content-title">Xoá sản phẩm</h5>
              <p className="dialog__content-message">Bạn có muốn xóa sản phẩm đang chọn?</p>
            </div>
          </div>
          <div className="dialog__control">
            <button className="dialog__control-btn dialog__control-btn--outline" onClick={handleRemove}>
              Xác nhận
            </button>
