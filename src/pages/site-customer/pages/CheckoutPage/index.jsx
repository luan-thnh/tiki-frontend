...
function CheckoutPage(props) {
  ...
  useEffect(() => {
    const getUser = async () => {
      const res = await dispatch(findUserById(userCurrent.id));
      setUser(res.payload);
      setInfoOrder({
        ...infoOrder,
  ...
  const handleAddInfo = async () => {
    setShowInfo(true);
    const res = await dispatch(updateUser({ ...user, ...infoOrder }));
    setUser({ ...res.payload });
  };
  ...
  return (
    <div className="container checkout">
      <div className="checkout__left">
        {isCheckoutSuccess && (
          <div className="container alert-success">
        ...
        <div className="checkout__form checkout--bg-white">
          ...
          <div className="checkout__form-container">
            ...
            <div className="checkout__form-group">
              ...
              <input type="text" name="phone" value={infoOrder.phone} onChange={handleChangeInput} />
            </div>
            <div className="checkout__form-group">
              <label htmlFor="" className="checkout__form-label">
                Tỉnh/Thành phố
        ...
        <div className="checkout__pay checkout--bg-white">
          ...
          <div className="checkout__pay-group">
            <input type="radio" name="pay-radio" id="cash-on-delivery" value="cash-on-delivery" defaultChecked />
